...
////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        // Acc register tile
        auto c_block_tile = decltype(block_flatmm(a_lds_gemm_window, b_lds_gemm_window)){};
/*
        // prefetch
        // global read 0
        //auto a_block_tile = load_tile(a_copy_dram_window);
        ...
        while(iCounter > 0)
        {
            ...
            // GEMM i
            block_flatmm(c_block_tile, a_lds_gemm_window, b_lds_gemm_window);
...
struct FlatmmPipelineAGmemBGmemCRegV1
{
    ...
    ) const
    {
        ...
        for(auto i = 0; i < b_flat_tile_size_per_thread; i++)
        {
            dbg_f16[gid * DEBUG_CNT + i + b_block_tile_size_per_thread] = b_flat_tile.get_thread_buffer()[i];
        }
#endif
